...
TEST(test_eff_spread_null_input) {
    ...
    FC_TEST_ASSERT_EQ(fc_ex_sig_eff_spread_batch(eff_out, trade_price, NULL, 10), FC_ERR_INVALID_ARG);
    FC_TEST_ASSERT_EQ(fc_ex_sig_eff_spread_batch(eff_out, trade_price, micro_price, 0), FC_ERR_INVALID_ARG);
}
