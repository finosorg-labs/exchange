...
static void bench_batch_fn(void* user_data) {
    ...
    fc_orderbook_snapshot_generate_batch(
        data->snapshots, data->orders, data->num_orders, data->num_symbols, MAX_LEVELS,
        FC_ORDERBOOK_PRECISION_KAHAN, 0
    );
}
